...
module.exports.run = async (bot, message, args) => {
  ...
  .addField('Guild Owner', `${guild.owner.user.tag === undefined ? "Cant't cache user!": guild.owner.user.tag}`, true)
  .addField('Created At', `${createdAt[0]} ${createdAt[2]} ${createdAt[1]} ${createdAt[3]}`, true)
  .addField('Region', guild.region.toUpperCase(), true)
  .addField('Total Members:', `${guild.memberCount === undefined ? "Cant't cache users!": guild.memberCount}`, true)
