...
module.exports.run = async (bot, message, args, db) => {
  ...
  if (!args[0]) {
    ...
    const utilEmbed = new Discord.RichEmbed()
      ...
      .addField(
        `\u2022 ${prefix}hb <extension> <code>`,
        `Generate a hastebin code link.`
      )
      .addField(
        `\u2022 ${prefix}ow find <username>`,
        `Get CSGO information about a user.`
      )
      .addField(
        `\u2022 ${prefix}fortnite <username>`,
        `Get fortnite information about a user.`
      )
      .addField(
        `\u2022 ${prefix}npm <search query>`,
        `Search about a npm package.`
      )
    ...
    const modEmbed = new Discord.RichEmbed()
      ...
      .setFooter(
        `Developed by Sync#066 | [UNDER DEVELOPMENT]`,
