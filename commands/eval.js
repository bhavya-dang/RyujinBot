...
module.exports.run = async (bot, message, args) => {
  ...
  try {
    ...
    botEvalEmbed.addField(
      "Type",
      `\`\`\`xl\n${
        (typeof botEvaled).substr(0, 1).toUpperCase() +
        (typeof botEvaled).substr(1)
      }\n\`\`\``
    );
    if (botEvaled.constructor.name == "Promise")
      botEvalEmbed.addField(
        "Output [Promise]",
        `\`\`\`\js\n${botEvaled}\n\`\`\``,
        false
