...
module.exports.run = async (bot, message, args) => {
  ...
  if(!message.guild.member(bot.user).hasPermission("ADMINISTRATOR")) return message.channel.send(
    new Discord.RichEmbed()
      .setTitle(`**ERROR**`)
      .setDescription(
  ...
  if (data) {
    if (args[0] === "prefix") {
      ...
      if(!channel || message.guild.channels.some(c => c.id === channel.id )) return message.channel.send(
        new Discord.RichEmbed()
          .setTitle("**ERROR**")
          .setDescription(
